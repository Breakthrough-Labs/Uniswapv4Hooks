...
import {VolatilityOracle} from "../../../../src/VOLATILITY_ORACLE/VolatilityOracle.sol";
...
contract VolatilityOracleTest {
    ...
    function setUp() public {
        ...
        hook = new VolatilityOracle{salt: salt}(IPoolManager(address(manager)));
